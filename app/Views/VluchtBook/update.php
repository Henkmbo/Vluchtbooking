...
<div class="container container-mvckdemo">
    <div class="wrapper-mvckdemo">
        <div class="form-group">
            <h2>Update sollicitant</h2>
            <form id="UpdateSollicitant" method="POST" action="<?= URLROOT; ?>/Sollicitant/update/<?= $data->Id ?>"
                autocomplete="on">
                ...
                <div class="form-group row">
                    ...
                    <select id="ddlGender" name="Genders" style="width:11.7rem;">
                        ...
                        <option value="Transgender" <?= ($data->Gender == "Transgender") ? "selected" : "" ?>>
                            Transgender</option>
                ...
                <div class="form-group row">
                    ...
                    <input type="date" style="width:11.7rem; class=" input-field-error-message" name="BirthDate"
                        required="true" value="<?= $data->BirthDate ?>">
                ...
                <div class="form-group row">
                    ...
                    <textarea name="Note" rows="4" cols="40" maxlength="200"><?= $data->Note ?></textarea>
